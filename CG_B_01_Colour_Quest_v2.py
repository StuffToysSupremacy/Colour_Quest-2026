...
def get_colours():
    ...
    :return: list of colours which each list item has the
...
def get_round_colours():
    ...
    while len(round_colours) < 4:
        ...
        # Get the score and check it's not all duplicate
...
class StartGame:
    ...
    def __init__(self):
        ...
        intro_string = ("In each round you will be invited to choose a colour. "
                        "Your goal is to beat the target score and win the round (and keep "
                        "your points).")
    ...
    def check_rounds(self):
        ...
        # Retrieve temperatures to be converted
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        self.stats_button.config(state=DISABLED)
         ...
         # Once interface has been created, invoke newF
    ...
    def new_round(self):
        ...
        # get round colours, median and highest score...
...
class DisplayHints:
    ...
    def __init__(self, partner, rounds_played):
        ...
        # disable hints stats AND end game buttons to prevent users
    ...
    def __init__(self, partner, all_stats_info):
        ...
        if total_score == max_possible:
            ...
            comment_string = {"Oops - You've lost every round! "
                              "You might want to loop at the hints!"}
